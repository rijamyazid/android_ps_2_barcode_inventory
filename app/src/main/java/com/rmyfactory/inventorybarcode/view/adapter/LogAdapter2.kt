...
class LogAdapter2: RecyclerView.Adapter<LogAdapter2.ViewHolder>() {
    ...
    fun addAdapterData(orderProducts: List<OrderProductWithProduct>) {
    ...
    inner class ViewHolder(private val binding: ItemHolderOrderBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(order: OrderProductWithProduct) {
            ...
            binding.tvOrderConfQty.text = order.orderProductModel.qty.toString()
